...
export const Bottombar = () => {
  return (
    <nav className="bg-background dark:border-border fixed right-0 bottom-0 left-0 z-50 flex h-14 w-full items-center shadow-[0_-2px_4px_rgba(0,0,0,0.1)] md:h-16 dark:border-t">
